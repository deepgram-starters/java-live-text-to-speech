# java-live-text-to-speech

Java (Javalin) demo app for Deepgram Live Text-to-Speech.
...
```
feat(java-live-text-to-speech): add diarization support
fix(java-live-text-to-speech): resolve WebSocket close handling
refactor(java-live-text-to-speech): simplify session endpoint
