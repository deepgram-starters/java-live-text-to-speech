# Java Live Text-to-Speech Makefile
...
help:
	@echo "Java Live Text-to-Speech - Available Commands"
	@echo "=============================================="
	@echo ""
	@echo "Setup:"
	...
	@echo ""
	@echo "Development:"
	@echo "  make build             Build backend JAR and frontend assets"
...
start-backend:
	...
	java -jar target/java-live-text-to-speech-1.0.0-shaded.jar
